...
namespace NetZlib
{
    ...
    sealed class InfBlocks
    {
        ...
        readonly int[] bb = new int[1]; // bit length tree depth 
        readonly int[] tb = new int[1]; // bit length decoding tree 

        readonly int[] bl = new int[1];
        readonly int[] bd = new int[1];

        readonly int[][] tl = new int[1][];
        readonly int[][] td = new int[1][];
        readonly int[] tli = new int[1]; // tl_index
        readonly int[] tdi = new int[1]; // td_index
